      ...
      <div className="max-w-6xl mx-auto">
        <Card className="rounded-3xl shadow-2xl border border-gray-200 overflow-hidden">
          ...
          <div className=" px-6 sm:px-10 py-10 text-center">
            <h1 className="text-3xl sm:text-4xl font-bold text-[#FF4C31] ">Add New Car</h1>

            <p className="mt-3 text-black  text-sm sm:text-base max-w-2xl mx-auto">
              Fill in the information below to list your vehicle for rent. Make sure every detail is
              accurate so customers can easily find and book your car.
            </p>
          </div>

          {/* Form */}
          <form onSubmit={onSubmit} className="p-5 sm:p-8 lg:p-10 space-y-8">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {/* Car Name */}
              <TextField name="carName" isRequired>
                <Label className="font-semibold mb-2">Car Name</Label>

                <Input placeholder="Toyota Corolla" className="h-12 rounded-xl" />
              ...
              <TextField name="dailyRentPrice" type="number" isRequired>
                <Label className="font-semibold mb-2">Daily Rent Price ($)</Label>

                <Input type="number" placeholder="80" className="h-12 rounded-xl" />
              ...
              <TextField name="seatCapacity" type="number" isRequired>
                <Label className="font-semibold mb-2">Seat Capacity</Label>
              ...
              <TextField name="pickupLocation" isRequired>
                ...
                <Input placeholder="Dhaka Airport" className="h-12 rounded-xl" />

                <FieldError />
              </TextField>

              {/* Availability */}
              <Select name="availability" isRequired placeholder="Availability Status">
                <Label className="font-semibold mb-2">Availability Status</Label>

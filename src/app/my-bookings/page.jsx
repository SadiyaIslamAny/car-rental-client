...
const MyBookingPage = async () => {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <h1 className="text-3xl md:text-4xl font-bold mb-8 text-center md:text-left">My Bookings</h1>
      ...
      {bookings.length === 0 ? (
        <div className="flex flex-col items-center justify-center py-24 border-2 border-dashed border-gray-300 rounded-3xl bg-gray-50">
          ...
          <p className="text-gray-500 mt-2 text-center max-w-md">
            No bookings found. Explore our available cars and make your first booking to get
            started.
          </p>
        </div>
      ) : (
            ...
            >
              ...
              <div className="flex flex-col sm:flex-row items-center sm:items-start gap-5 flex-1">
                ...
                <div className="flex-1 text-center sm:text-left">
                  <h2 className="text-xl md:text-2xl font-bold">{booking.carName}</h2>

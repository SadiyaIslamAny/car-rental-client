              ...
              <Surface variant="default">
                ...
                >
                  <div className="text-center">
                    <h2 className="text-3xl font-bold text-[#FF4C31]">Update Car</h2>

                    <p className="text-gray-500 mt-2">Update your car information.</p>
                  </div>

                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <TextField name="carName" defaultValue={carName} isRequired>
                      <Label className="font-semibold mb-2">Car Name</Label>
                      <Input placeholder="Toyota Corolla" className="rounded-xl h-12" />
                      <FieldError />
                    </TextField>
                    ...
                    >
                      ...
                      <Input placeholder="80" className="rounded-xl h-12" />
                      <FieldError />
                    </TextField>
                    ...
                    >
                      ...
                      <Input placeholder="5" className="rounded-xl h-12" />
                      <FieldError />
                    </TextField>
                    <TextField name="pickupLocation" defaultValue={pickupLocation} isRequired>
                      <Label className="font-semibold mb-2">Pickup Location</Label>

                      <Input placeholder="Dhaka Airport" className="rounded-xl h-12" />
                      <FieldError />
                    </TextField>
                    <Select
                      name="availability"
